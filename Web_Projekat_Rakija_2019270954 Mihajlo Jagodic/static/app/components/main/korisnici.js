...
<div class="w-50" style="margin-left:350px;">
    <korisnik-form v-on:sacuvaj="createKorisnik" v-bind:naslov="'Dodaj korisnika'" v-bind:dugme="'Registruj se'"></korisnik-form>
</div>
<button v-on:click="navigate('korisnici')" type="button" class="btn btn-primary btn-lg btn-block m-3">Prijavljeni korisnici</button>
