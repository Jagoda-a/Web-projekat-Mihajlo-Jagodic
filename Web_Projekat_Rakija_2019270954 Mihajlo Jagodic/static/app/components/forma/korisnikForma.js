export default {
    ...
    template:  `
<form v-on:submit.prevent="$emit('sacuvaj', {...noviKorisnik})" class="w-85 p-3 container fade-in">
<p class="bojab"><b>-{{naslov}}</b></p>

<div class="mb-3">
    <label class=" bojab form-label">E-mail: </label>
...
<div class="mb-3">
    <label class=" bojab form-label">Lozinka: </label>
